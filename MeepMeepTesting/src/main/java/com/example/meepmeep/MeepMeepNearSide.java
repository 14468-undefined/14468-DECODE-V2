...
public class MeepMeepNearSide {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity botMotifs = new DefaultBotBuilder(meepMeep)
                .setDimensions(9,18)
                .setConstraints(60, 60, Math.toRadians(180), Math.toRadians(180), 15)
                .build();

        botMotifs.runAction(botMotifs.getDrive().actionBuilder(new Pose2d(-48.5, 48.8, Math.toRadians(135)))
                // ==============Motif 1============== \\

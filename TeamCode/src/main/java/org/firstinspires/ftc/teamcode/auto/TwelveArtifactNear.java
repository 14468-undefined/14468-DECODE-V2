...
@Autonomous(name="B_12+0 near")
class BlueTwelveArtifactNear extends SampleAuto {
...
@Autonomous(name="R_12+0 near")
class RedTwelveArtifactNear extends SampleAuto {
    private BaseRobot robot;
    private ShootCommand shoot3;
    private IntakeCommand intake;
    ...
    @Override
    public void onInit() {
        robot = new BaseRobot(hardwareMap, new Pose2d(-48.5, 48.8, 135));
        shoot3 = new ShootCommand(robot, 3, 2);//3 artifacts mid range shot
        intake = new IntakeCommand(robot);
        //set pos of hood and transfer servo
    ...
    public void onStart() {
        ...
        Actions.runBlocking(robot.drive.actionBuilder(robot.drive.getPose())
                ...
                // Start intake after 2 seconds
                .afterTime(2, t -> {robot.intake.intake(); return true;})
                .afterTime(2, t -> {robot.transfer.spinReverse(); return true;})
                //stop intake after 7 sec
                .afterTime(3, t -> {robot.intake.stop();  return true;})
                .afterTime(3, t -> {robot.transfer.stop(); return true;})
